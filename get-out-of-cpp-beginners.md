...
メンテナンス性は必ずしも C++ 特有の話ではなく、プログラミング、ソフトウェア設計実装において重要な話題です。
C++ は一歩間違えるとコードや実行結果が大変なことになる気難しい側面がありますので、とりわけメンテナンス性について
もう少し具体的に考えてみたいと思います。
...
あくまで部品化は、メンテナンス性のための手段のひとつであり、部品化が至上命題ではありません。
